...
const calculateEngravingPrice = (message = "", pricePerWord = 0) =>
  message.split(" ").length * pricePerWord; // выводим в return количество слов (для того чтобы его узнать, преобразуем строку в массив и узнаем его длину lenth (в массив - потому что lenth строки - это количество символов, а нам нужно количество слов)) и умножаем на цену одного словаWrite code in this line
